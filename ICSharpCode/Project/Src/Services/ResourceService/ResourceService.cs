...
namespace ICSharpCode.Core
{
	...
	public static class ResourceService
	{
        ...
        {
            Bitmap imageResource = (Bitmap)GetImageResource(name);
            Debug.Assert(imageResource != null, "Resource " + name);
        ...
        public static Icon GetIcon(string name)
        {
            ...
            {
                return (Icon)imageResource;
            }
            return Icon.FromHandle(((Bitmap)imageResource).GetHicon());
        }
